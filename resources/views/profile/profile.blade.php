      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Tontina</a></li>
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                <div class="card-header pb-0 p-3">
                  <h6 class="mb-0">Tontina Settings</h6>
                </div>
                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="javascript:;">
                        <i class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="modal" data-bs-target="#modalScrollable" title="Edit Profile"></i>
                      </a>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                          <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('profile.update', $user->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="anneeNais" class="col-md-4 col-form-label text-md-right">Date de Naissance</label>
                                    <div class="col-md-6">
                                        <input id="anneeNais" type="date" class="form-control @error('anneeNais') is-invalid @enderror" name="anneeNais" value="{{ $user->anneeNais }}" required autocomplete="anneeNais">
                                        @error('anneeNais')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    <label for="nbDeFemmes" class="col-md-4 col-form-label text-md-right">{{ __('Nombre de femmes') }}</label>

                                    <div class="col-md-6">
                                        <input id="nbDeFemmes" type="number" class="form-control @error('nbDeFemmes') is-invalid @enderror" name="nbDeFemmes" value="{{ $user->nbDeFemmes }}" required>
                                ...
                                <!--<div class="form-group row">
                                    <label for="login" class="col-md-4 col-form-label text-md-right">Identifiant</label>

                                    <div class="col-md-6">
                                        <input id="login" type="text" class="form-control @error('login') is-invalid @enderror" name="login" value="{{ $user->login }}" required>
                                ...
                                <!--<div class="form-group row">
                                    <label for="valide" class="col-md-4 col-form-label text-md-right">{{ __('Validé') }}</label>

                                    <div class="col-md-6">
                                        <select id="valide" class="form-control @error('valide') is-invalid @enderror" name="valide">
                                ...
                                <div class="form-group row">
                                    <label for="nomEpoux" class="col-md-4 col-form-label text-md-right">Nom de l'époux</label>

                                    <div class="col-md-6">
                                        <input id="nomEpoux" type="text" class="form-control @error('nomEpoux') is-invalid @enderror" name="nomEpoux" value="{{ $user->nomEpoux }}">
                                ...
                                <div class="form-group row">
                                    <label for="telephone1" class="col-md-4 col-form-label text-md-right">Téléphone 1</label>

                                    <div class="col-md-6">
                                        <input id="telephone1" type="text" class="form-control @error('telephone1') is-invalid @enderror" name="telephone1" value="{{ $user->telephone1 }}">
                                ...
                                <div class="form-group row">
                                    <label for="telephone2" class="col-md-4 col-form-label text-md-right">Téléphone 2</label>

                                    <div class="col-md-6">
                                        <input id="telephone2" type="text" class="form-control @error('telephone2') is-invalid @enderror" name="telephone2" value="{{ $user->telephone2 }}">
